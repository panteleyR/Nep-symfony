...
abstract class PhpReferenceCompatibility implements IteratorAggregate, ArrayAccess, Serializable, Countable
{
    ...
    public function __isset($key)
    {
        ...
        if (in_array($key, $this->protectedProperties)) {
            throw new Exception('$key is a protected property, use a different key');
        }
    ...
    public function exchangeArray($data)
    {
        if (!is_array($data) && !is_object($data)) {
            throw new Exception('Passed variable is not an array or object, using empty array instead');
        }
    ...
    public function setIteratorClass($class)
    {
        ...
        throw new Exception('The iterator class does not exist');
    }
